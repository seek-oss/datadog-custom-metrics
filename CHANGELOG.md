...
- Allow hot-shots 17.x in peer dependencies ([#393](https://github.com/seek-oss/datadog-custom-metrics/pull/393))
...
- Migrate to ESM ([#384](https://github.com/seek-oss/datadog-custom-metrics/pull/384))
